...
with tab1:
    ...
    input_file = st.file_uploader("施策一覧をアップロード", type=["xlsx"], key="input1")
...
with tab2:
    ...
    reg_file = st.file_uploader("回帰分析用ファイルをアップロード", type=["xlsx"], key="input2")
